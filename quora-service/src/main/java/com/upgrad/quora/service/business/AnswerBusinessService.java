...
public class AnswerBusinessService {
    ...
    public AnswerEntity createAnswer(AnswerEntity answerEntity , UserAuthenticationEntity userAuthEntity) throws AuthorizationFailedException {
    ...
    @Transactional(propagation = Propagation.REQUIRED)
    public AnswerEntity verifyAnswerBelongsToUser(UserAuthenticationEntity userAuthEntity, AnswerEntity answerEntity) throws AuthorizationFailedException {
